...
- **Single commit, version bump:** All 8 units land in one commit following the `bulk-metadata-sync-2026-06-13.md` workflow. Version bump from current → 1.4.0 (MINOR per semver: new user-facing feature = mode ask; no breaking schema changes). CHANGELOG entry under `[Unreleased]`.
...
- **Versioning:** MINOR version bump (current → 1.4.0) per `coordinated-versioning-ecosystem-2026-06-13.md` — adding a user-facing feature without breaking changes.
