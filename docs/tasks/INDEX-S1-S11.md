...
|----|------|--------|--------------|-------|------------|
| S1 | Analyze pwrl-work Structure | to-do | — | — | Small |
| S2 | Extract Triage Logic (U1) | to-do | S1 | pwrl-work-triage/SKILL.md | Medium |
| S3 | Extract Prepare Logic (U2) | to-do | S1, S2 | pwrl-work-prepare/SKILL.md | Large |
| S4 | Create GitHub Sync Utility (U3) | to-do | S1 | pwrl-work-sync-status/SKILL.md | Medium |
...
| S9 | Update Fallback Logic | to-do | S1, S8 | pwrl-work/SKILL.md | Medium |
