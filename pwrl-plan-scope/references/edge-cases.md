...
2. Ask via `ask_user_question`: "This plan was created on [date]. Is it still relevant, or should we create a new plan?"
3. Offer options:
...
2. Ask via `ask_user_question`: "Multiple plans found. Which one should I use, or create new?"
3. Offer options:
